...
class simpleGUI_tk(tk.Tk):
    ...
    def runFinderProgram(self,event):
        print("")
    ...
    def menu(self):
        ...
        self.bind("<Control-h>", self.helpFinder)
